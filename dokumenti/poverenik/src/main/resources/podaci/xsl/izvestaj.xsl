            ...
            <fo:page-sequence master-reference="izvestaj-page">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block font-family="sans-serif" font-size="16px" padding="1px" text-align="center">
                            ...
                            <xsl:value-of select="d:message/d:godina"/>. god. 
                    </fo:block>
                                  ...
                                  <fo:table-cell padding="10px">
                                      <fo:block font-weight="bold">
                                          ...
                                          <fo:inline vertical-align="super" font-size="12px">
                                              <xsl:value-of select="d:message/d:br_podnetih_zahteva"/>
                                          </fo:inline>
                                      </fo:block>
                                  </fo:table-cell>
                                  <fo:table-cell padding="10px">
                                      <fo:block font-weight="bold">
                                          ...
                                          <fo:inline vertical-align="super" font-size="12px">
                                              <xsl:value-of select="d:message/d:br_odbijenih_zahteva"/>
                                          </fo:inline>
                                      </fo:block>
                                  </fo:table-cell>
                                  <fo:table-cell padding="10px">
                    ...
                    <fo:block>
                        Broj podnetih žalbi u godini: <xsl:value-of select="d:message/d:br_zalbi"/>
