...
import com.xml.poverenik.rdf.AuthenticationUtilities.ConnectionProperties;
...
public static ArrayList<String> executeQuery( Map<String, String> params, String metadataGraphUri, String queryFile) throws IOException {
		
		ConnectionProperties conn = AuthenticationUtilities.loadProperties(metadataGraphUri);
		
		String sparqlQueryTemplate = readFile(queryFile, StandardCharsets.UTF_8);
