package com.xml.projekat.config;
...
import com.xml.projekat.security.auth.RestAuthenticationEntryPoint;
import com.xml.projekat.security.auth.TokenAuthenticationFilter;
import com.xml.projekat.service.CustomUserDetailsService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.GET, "/api/zahtev/**");
