            	...
            	<br></br>
	            	...
	            	<div style="text-align:center;">
	                	...
	                	<h2 style="text-align:center;">Primena Zakona o slobodnom pristupu informacijama od javnog znacaja u
	                            <xsl:value-of select="d:izvestaj/d:godina"/>. god.</h2>
	                </div>
	               	 	<br></br>
	                	<br></br>
	                	<h4>1. Zahtevi</h4>
	                	...
	                	<table border="1px" style="border-collapse: collapse;">
	                		...
	                		<tbody>
	                			...
	                			<tr style="text-align: center;  vertical-align: middle;">
	                				<td padding="10px"><xsl:value-of select="d:izvestaj/d:br_podnetih_zahteva"/></td>
	                				<td padding="10px"><xsl:value-of select="d:izvestaj/d:br_odbijenih_zahteva"/></td>
	                	...
	                	<br></br>
	                	<h4>1. Zalbe</h4>
	                	<p>Broj podnetih zalbi u godini: <xsl:value-of select="d:izvestaj/d:br_zalbi"/></p>
